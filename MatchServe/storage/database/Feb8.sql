...
--
-- Table structure for table `projectcause`
--

CREATE TABLE IF NOT EXISTS `projectcause` (
  `ProjectID` int(11) NOT NULL,
  `CauseID` int(11) NOT NULL,
  PRIMARY KEY (`ProjectID`,`CauseID`),
  KEY `CauseID` (`CauseID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `projectcause`
--

INSERT INTO `projectcause` (`ProjectID`, `CauseID`) VALUES
(1, 1),
(2, 2),
(8, 2),
(11, 2),
...
INSERT INTO `projecttime` (`ProjectID`, `TS_ID`) VALUES
(1, 115),
(1, 116),
(1, 117),
(6, 120),
...
CREATE TABLE IF NOT EXISTS `userproject` (
  ...
  `ProjectID` int(11) NOT NULL,
  `TS_ID` int(11) NOT NULL,
  PRIMARY KEY (`UserID`,`ProjectID`,`TS_ID`),
  KEY `ProjectID` (`ProjectID`),
  KEY `TS_ID` (`TS_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(2, 'Pierre Tasci', 'tasci@usc.edu', 'password', 0, '0000-00-00', 0, 0, '', 0),
(3, 'Rodrigo Santos', 'rigotek@gmail.com', '123', 0, '0000-00-00', 0, 0, '', 0),
(4, 'Anita Singh', 'anitas3791@gmail.com', 'aaa', 0, '0000-00-00', 0, 0, '', 0),
(5, 'Jessica', 'itsjesschen@gmail.com', 'jessica', 0, '0000-00-00', 0, 0, '', 0),
(6, 'batman', 'batman@gmail.com', 'alfred', 0, '0000-00-00', 0, 0, '', 0);
...
--
-- Constraints for table `projectcause`
--
ALTER TABLE `projectcause`
  ADD CONSTRAINT `projectcause_ibfk_2` FOREIGN KEY (`CauseID`) REFERENCES `causes` (`CauseID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `projectcause_ibfk_1` FOREIGN KEY (`ProjectID`) REFERENCES `projects` (`ProjectID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `projecttime`
--
ALTER TABLE `projecttime`
  ADD CONSTRAINT `projecttime_ibfk_2` FOREIGN KEY (`TS_ID`) REFERENCES `timeslot` (`TS_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `projecttime_ibfk_1` FOREIGN KEY (`ProjectID`) REFERENCES `projects` (`ProjectID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `userproject`
--
ALTER TABLE `userproject`
  ADD CONSTRAINT `userproject_ibfk_3` FOREIGN KEY (`TS_ID`) REFERENCES `timeslot` (`TS_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
