...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2013 at 08:08 PM
...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  `Address` char(200) DEFAULT NULL COMMENT 'Whole address. If it is NULL, it is an ONLINE opportunity.',
...
INSERT INTO `projects` (`ProjectID`, `ProjectName`, `Details`, `Address`, `StartTime`, `EndTime`, `Spots`, `Admin`, `Status`, `Requirements`, `Headline`, `Image`, `Longitude`, `Latitude`) VALUES
(14, 'Web Developer', 'Knowledge of Lavarel, PHP and MySQL required. More backend development is involved.', '90071', '2013-03-04 10:00:00', '2013-03-08 16:00:00', 2, 1, 'Open', NULL, 'Know backend web dev?? Prove it!', '', 0, 0),
(15, 'Kitchen Help', 'We need help unloading food cargo from the trucks. These food supplies then needs to be shelved. Help distribute food out as well. Lastly, help clean up the kitchen!', '90012', '2013-03-05 16:00:00', '2013-03-05 19:00:00', 10, 1, 'Open', NULL, 'Help feed the homeless!', '', 0, 0),
(16, 'Family Counselor', 'Help counsel rape victims and their family. These people have suffered more than anyone should.', '90057', '2013-03-11 00:00:00', '2013-04-11 00:00:00', 1, 3, 'Open', 'Need to be certified professional. We will conduct a background check upon application.', 'Help those who really need it.', '', 0, 0),
(17, 'Special Events Co-ordinator', 'Weeklong awareness campaign at LA Live! We need professional help to plan and coordinate the entire event with Downtown Women''s Center board!', '90015', '2013-03-11 00:00:00', '2013-03-15 00:00:00', 1, 3, 'Open', 'Professional background in events coordination', 'Are you OCD when it comes to event planning? We need you!', '', 0, 0),
(18, 'Plumber', 'Unclog every single clogged pipe in the entire building! It''s stuck with grimy, disgusting goo that no one else would go within 500 feet off.', '90201', '2013-03-20 09:00:00', '2013-03-20 16:00:00', 0, 2, 'Open', NULL, 'Get down and dirty to clean!', '', 0, 0),
(19, 'Child Care Co-ordinator', 'Help coordinate our child care efforts. Tasks range from hiring additional child carers as well as overseeing the entire operation.', '90007', '2013-03-04 00:00:00', '2013-09-04 00:00:00', 1, 2, 'Open', 'Must pass background check.', 'Love children? Love ordering people around?', '', 0, 0),
(20, 'Brand Awareness Ambassador', 'Raise awareness about the organization at USC. Includes handing out flyers around the school, sticking posters all around the campus and nagging students as they eat at the campus center.', '90089', '2013-03-18 00:00:00', '2013-03-22 00:00:00', 10, 12, 'Open', NULL, 'It''s all in the brand.', '', 0, 0),
(21, 'Social Worker Internship', 'Help do stuff around the office. You''re responsible for everything anyone tells you. Yes, that includes the janitor. But seriously, this internship will look so good on your resume, you''ll stand out like a sore thumb among all the other plain resumes.', '90803', '2013-04-01 00:00:00', '2013-10-01 00:00:00', 4, 12, 'Open', NULL, 'Help us, help you.', '', 0, 0),
(24, 'Art Teacher', 'Help Main Fullterton Elementary School fill an open position. Teach aspiring artists how to get things done!', '92833', '2013-04-01 00:00:00', '2013-11-02 00:00:00', 1, 5, 'Open', 'Degree in education is required.', '', '', 0, 0),
(25, 'Yoga Instructor', 'Teach yoga for one week (Our current instructor is getting married and is on his honeymoon). Sorry we do not provide any clothing or mats. We don''t have a location too so if we can use your place, that''d be great.', '90089', '2013-03-18 00:00:00', '2013-03-22 00:00:00', 1, 5, 'Open', 'Licensed instructors only! No perverts.', '', '', 0, 0),
(26, 'Spiritual Development', 'People need direction in their spiritual life. Why not be that guiding light for them in this time of need?', '92821', '2013-03-26 09:00:00', '2013-03-26 14:00:00', 2, 13, 'Open', NULL, 'Spiritually Drained Aid', '', 0, 0),
(27, 'Homeless Shelter VP', 'Our previous VP is no longer capable of overseeing the entire operation (he is now homeless too. Can you imagine that? What would the press think omg). Help our create errands for our other volunteers to help homeless people.', '90013', '2013-03-01 00:00:00', '2014-03-01 00:00:00', 1, 13, 'Open', NULL, 'The homeless plight continues.', '', 0, 0);
